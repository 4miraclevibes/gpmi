<footer class="bg-dark text-white py-5" style="background-color: #075308 !important;">
    <div class="container">
        <div class="row">
            <div class="col-md-8">
                <img src="https://filemanager.layananberhentikuliah.com/storage/files/WvEebn5l9SpYXZKATBrOi1rgsM1Skc6TpQFBPjVa.png" alt="Logo" class="mb-3" width="150">
                <p>
